...
This is a 3D-printable case designed for the RP2350-Zero - Waveshare  development board, intended to transform it into a robust and portable FIDO2 hardware security key with direct USB-C plug-in capability.



This case requires the pico-fido firmware, which is available from the author's open-source repository at: polhenarejos/pico-fido



🚀 Key Features:

Custom-Fit: Perfectly tailored for the RP2350-Zero - Waveshare  board and fully compatible with the pico-fido project.
...
Recommended Material: It is recommended to use photocuring resin (v3.1) for printing.
...
For a more permanent and secure assembly, this case comes with its own snap-fit locking mechanism to prevent detachment.
...
RP2350-Zero - Waveshare  development board
...
Official Repository: https://github.com/GN998/ZeroKey



Unauthorized mirrors of this repository may be found on other platforms. Please be sure to visit the official GitHub repository.
